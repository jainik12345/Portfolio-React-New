...
export default function Resume() {
  ...
  const handleDownload = () => {
    ...
    window.location.href =
      "https://drive.google.com/uc?export=download&id=1lm7zH9KeQ6TK36VvYs9qO34YKKla_2nD";
  };
    ...
    <Box>
      ...
      <Box pt={{ base: "40px", md: "80px", xl: "80px" }}>
        <Flex justifyContent="center" alignItems="center">
          ...
          >
            <iframe
              src="https://drive.google.com/file/d/1lm7zH9KeQ6TK36VvYs9qO34YKKla_2nD/preview"
              title="Resume"
              width="100%"
              height="100%"
